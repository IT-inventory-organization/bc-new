<template lang="">
  <v-card height="95vh">
    ...
    <v-container>
      ...
      <v-row no-gutters>
        <v-col cols="4"> </v-col>
        <v-col cols="3" class="tanggal"> 01-01-2021 </v-col>
      </v-row>
      ...
      <v-row no-gutters class="subtitle card-subtitle">
        <v-col cols="12" class="list-title"> KAPAL PEMBELI </v-col>
        <v-col cols="12" class="list-item"> Value </v-col>
        <v-col cols="12" class="list-title"> KAPAL PEMILIK </v-col>
        <v-col cols="12" class="list-item"> Value </v-col>
      </v-row>
